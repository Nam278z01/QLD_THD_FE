...
import WalletDetailModal from "../modal/WalletHistoryDetailModal ";
          ...
          {data.length > 0 ? (
            data.map((d, index) => (
              <div
                ...
                key={index}
              >
                {d.TransactionMethod === 3 || d.TransactionMethod === null ? (
                  <div
                ...
                {d.TransactionMethod === 3 || d.TransactionMethod === null ? (
                  ...
                  >
                    <span
                      className={
                        d.Sender.ID !== userID ? "text-success" : "text-danger"
                      }
                    >
                      {d.Sender.ID !== userID
                        ? "+" + d.CoinNumber * 1
      ...
      {data.length > 4 && (
        <div className="text-center mt-2">
          <Link
            ...
            to={`/wallet/wallet-history/${account}`}
          >
