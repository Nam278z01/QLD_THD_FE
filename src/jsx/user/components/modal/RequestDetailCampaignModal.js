...
export default function RequestDetailCampaignModal({
  show,
  setShow,
  requestID,
  approve,
  ...
  const [data] = useRefreshToken(getRequestCampaignDetail, requestID);
          ...
          <div className="d-flex flex-row gap-3 justify-content-end">
            ...
            <Button
              ...
              onClick={(e) => {
                ...
                navigate.push(`/point/edit-campaign-request/${data.ID}`);
              }}
            >
              Edit
            </Button>
      ...
      <div className="row">
        <div className="col-6 ">
          ...
          <div className="row">
            ...
            <div className="col-7">
              <p className="text-break mb-2 fs-6 ">{data.Campaign.Name}</p>
            </div>
          </div>
          {data.Description ? (
            <div className="row">
