  ...
  return ( 
    <div className="col-4 my-2">
      <div className=" py-4 align-items-center  p-2 border bg-light rounded">
        ...
        {(datas.Groups.length !==0) ?<div className="m-2 text-blue" style={{ minHeight: 45 }}>
          Group:
          ...
          {datas.Groups.map((i) => (
            <button
              ...
              onClick={(e) => {}}
            >
              <text className="m-2">{i.Name}</text>
            </button>
          ))}
        </div>:<div className="m-2 text-blue" style={{ minHeight: 45 }}>
        Group: None
        </div>}
