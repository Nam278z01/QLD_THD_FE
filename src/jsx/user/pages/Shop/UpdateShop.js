...
const UpdateShop = () => {
    ...
    const valiSchema = Yup.object().shape({
        Name: Yup.string().trim().typeError('Please enter Name').required('Please enter Name'),
    ...
    function UpdateProductFunc(body) {
        ...
        getTokenFormData(updatePersonalShop, 'Updated success', success, false, ID, dataToSend);
    }
    return Shop === null ? (
        <Loading />
    ) : (
                                    ...
                                    >
                                        <div className="row">
                                            <div className="col-xl-6">
                                                ...
                                                <div
                                                    className={`form-group mb-3 row ${
                                                        values.Price ? (errors.Price ? 'is-invalid' : 'is-valid') : ''
                                                    }`}
                                                >
                                                    <label className="col-lg-4 form-label" htmlFor="Price">
                                                ...
                                                >
                                                    <label className="col-lg-4 form-label" htmlFor="Quantity">
                                            ...
                                            <div className="col-xl-6">
                                                ...
                                                >
                                                    <label className="col-lg-4 form-label" htmlFor="ImageURLText">
                                                    ...
                                                    <div className="col-lg-6">
                                                        ...
                                                        >
                                                            Please choose the file that have size smaller than 200kb
                                                        </div>
