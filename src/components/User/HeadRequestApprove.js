...
function HeadRequestApprove({ ...prop }) {
    ...
    const handleImport = (file) => {
        ...
        getTokenFormData(uploadPointExcelBUL, 'Import success', success, null, formData, DepartmentID);
    };
    // handle export template
    const handleExport = () => {
        const exportFileName = `HEAD-POINT-TEMPLATE(${moment(new Date()).format('DD-MM-YYYY')})`;
        getTokenDownload(getExcelHead, exportFileName, DepartmentID, page, pageSize, sortQuery);
    };
    return (
        <div>
            <Row>
...
export default HeadRequestApprove;
